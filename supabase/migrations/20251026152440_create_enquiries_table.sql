/*
  ...
  2. Security
    ...
    - Add policy for anyone to submit enquiries
    - Add policy for landing page owners to view/manage enquiries
*/
...
CREATE INDEX idx_enquiries_landing_page_id ON enquiries(landing_page_id);
